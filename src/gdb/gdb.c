...
//        case 'z':
//        case 'Z':
//            gdb_cmd_breakpoint(buffer, len - 1);
//            break;
...
//        switch (cmd_type) {
//            case '+':
//                dw_ll_flash_read(0, 64, buffer);
//                usb_cdc_write(buffer, 64);
//                dw_ll_flash_read(64, 64, buffer);
//                usb_cdc_write(buffer, 64);
//                dw_ll_flash_read(128, 64, buffer);
//                usb_cdc_write(buffer, 64);
//                dw_ll_flash_read(192, 64, buffer);
//                usb_cdc_write(buffer, 64);
//                break;
//            case '*':
//                dw_env_open(DW_ENV_FLASH_WRITE);
//                dw_ll_flush_breakpoints(buffer, 32);
...
//                break;
//            default:
//                if(cmd_type & 0x80) dw_ll_remove_breakpoint(cmd_type & 0x7F);
//                else dw_ll_add_breakpoint(cmd_type & 0x7F);
//        }
